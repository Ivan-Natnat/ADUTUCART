...
import com.example.adutucart5.databinding.LayoutCartItemBinding
...
class CartAdapter (val context: Context,val list: List<ProductModel>) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CartViewHolder {
        val binding = LayoutCartItemBinding.inflate(LayoutInflater.from(context), parent
            ,false)
    ...
    override fun onBindViewHolder(holder: CartViewHolder, position: Int) {
        ...
        holder.binding.textView14.text = list[position].productSp
